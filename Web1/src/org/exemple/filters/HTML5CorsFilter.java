...
public class HTML5CorsFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        res.addHeader("Access-Control-Allow-Origin", "*");//* toutes les adresses ip sont autorisées
        res.addHeader("Access-Control-Allow-Methods", "GET, POST, DELETE, PUT");//ici toutes les méthodes sont autorisées
        res.addHeader("Access-Control-Allow-Headers", "Content-Type");//en disant content-type je dis  que tout format est autorisé
